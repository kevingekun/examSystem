...
// ***************************************************************** 
function Folder(folderDescription, hreference, onclickjs) //constructor 
{ 
  //constant data 
...
{ 
  var docW = "";
 	...
 	if(this.hreference)
  	docW = docW + "<a style='text-decoration: none; cursor: hand' href='" + this.hreference + "' "
	else
	  docW = docW + "<a style='text-decoration: none; cursor: hand' "
  ...
  if (browserVersion > 0) { 
    	if(this.onclickjs)
    		//docW = docW + "onClick='clickOnFolder(\""+this.getID()+"\");" + this.onclickjs + "' "
    		docW = docW + "onClick='clickOnFolder(\""+this.getID()+"\");" + this.onclickjs + "' "
...
function gFld(description, hreference, onclickjs) 
{ 
  folder = new Folder(description, hreference, onclickjs);
  return folder;
} 
