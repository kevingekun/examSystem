...
String fileUrlPath = "../"+pu.getProperties("path.fabu.url")+"case/"+user.getUserType()+"/";
...
if(fileid!=null&&fileid.length()>0&&!fileid.equals("null")){
 fathernode = (CaseNode)t.getNodeById(Node.getNodeType("case"),new Long(fileid.substring(0,fileid.length()-5)));
 }
