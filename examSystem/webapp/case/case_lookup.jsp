...
<jsp:useBean id = "list" class="com.wondersgroup.falcon.beans.archives.CaseTree"/>
<%@ page import="java.util.*" %>
<%@ page import="com.wondersgroup.falcon.model.archives.CaseNode" %>
...
<link href="../inc/all.css" rel="stylesheet" type="text/css">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form method = "post" action = "case_lookup.jsp" name="lookup">
          ...
          <tr> 
            ...
            <td  ><input type = "button" class = "SmallButton" name = "button_editfile" value = "查 询&nbsp;&nbsp;" onclick = "submit()"></td>
          </tr>
										...
										if (request.getParameter("keyword") != null){
											...
											//out.print(l.size());
												for (Iterator it = l.iterator(); it.hasNext();) {
													CaseNode tmp = (CaseNode) it.next();
													//out.println(tmp.getId());
													out.println("<tr bgcolor=\"#FFFFFF\"> ");

														//out.println("<td>&nbsp;</td>");
													out.println("<td align=left><a href=case_file.jsp?fileid=" + tmp.getAttribute().getHtmlFile() + "&id=" + tmp.getId() + " target='_self'>" + tmp.getName() + "</a></td>");
													out.println("</tr>");
												}
										}
										%>
...
<form method = "post" action = "case_list.jsp" name="list">
