...
<table width="98%" height="33" border="0" align="center" cellpadding="0" 
    ...
    <tr> 
      <td bgcolor="#FFFFFF" width="20%"><div align="center">
		<iframe name="LeftTree" src="user_grouptree.jsp" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto" width="200" height="1700px"></iframe></div>
	  </td><td bgcolor="#FFFFFF" width="80%">
	 	 <iframe name="MainWin" src="" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto" width="100%" height="1700px"></iframe>
	  </td>
    </tr>
