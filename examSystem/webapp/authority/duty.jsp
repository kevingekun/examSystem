                      ...
                      <tr>
                        <td><table width="100%" border="0" align="left"  >
                            <tr>
                              ...
                              <td  class="header8">专家信息</td>
                            </tr>
                        </table></td>
                      </tr>
                    </table>
<form id="duty"  name="duty" method="post"  action="duty.action">
<input id="committeeId" name="committeeId" type="hidden" value="<c:out value="${committeeid}"/>"/>
  <input id="KCID" name="KCID" type="hidden" value="<c:out value="${Kcid}"/>"/>
   <input id="KCID" name="KSID" type="hidden" value="<c:out value="${Ksid}"/>"/>
 ...
 <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
           <td width="13%" align="right">备注：</td>
	           ...
	           <textarea rows="3" cols="16"  name="nremark" id="nremark"></textarea>
	             </td>  
          </tr>
  			<tr height="75">
						<%--<td colspan="2"></td>
						--%><td ><div style="margin-left:400px" ><input type="submit" class="submit_2" value="确定"   name="button_submit" /></div></td>
						<td ><div style="margin-left:70px" ><input type="button" class="submit_2" value="重置" onclick="doreset()" name="button_reset" /></div></td>
