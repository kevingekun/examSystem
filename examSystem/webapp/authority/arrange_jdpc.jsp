...
/* function sbt(){
    ...
    var checkedid="";
	var values = document.getElementsByName("checkedid");
	var zymc = document.getElementById("sjmc").value;
							...
							<td class="borader3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_list" id="tb">
									<tr class="title_font">
										...
										<td width="40%" align="center" bgcolor="#C7E2F8"><span class="out">鉴定批次号</span></td>
										<td width="20%" align="center" bgcolor="#C7E2F8"><span class="out">考生人数</span></td>
									...
									<c:forEach var="aBean" items="${list}" varStatus="status">
										<tr onMouseOver="this.className='td_over'" onMouseOut="this.className=''" id='r1'>
											<td align='center' class='num_font'><input type="checkbox" id="checkbox" name="checkedid" value="<c:out value='${aBean.jd_id}'/>" /></td>
											<td align='center' class='num_font'><c:out value="${status.index+1}" /></td>
											<td align='center' class='num_font'><c:out value="${aBean.jd_mc}" /></td>
											<td align='center' class='num_font'><c:out value="${aBean.ks_rs}" /></td>
											<td>
											<input type="button" class="submit_2" onClick="detailjdpc(<c:out value='${aBean.jd_id}'/>)"  value="查看详情"/>
											<input type="button" class="submit_2" onClick="deletejdpc(<c:out value='${aBean.jd_id}'/>)"  value="删除"/></td>
										</tr>
									</c:forEach>
								</table> 
