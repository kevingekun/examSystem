  ...
  <head>
	...
	$(document).ready(function(){
		...
		$.ajax({
			type: 'post',
			async: false,
			url: 'getDetailPrintCard.action?jdid='+id,
			success:function(result){
				...
				$.each(data, function(i, n) {
					...
					cell3.innerHTML=data[i]['idcard'];
					var cell3 = row.insertCell(3);
					cell3.innerHTML=data[i]['zkh'];
					var cell4 = row.insertCell(4);
					cell4.innerHTML=data[i]['dw_name'];
					var cell5 = row.insertCell(5);
					cell5.innerHTML=data[i]['kc_name'];
					var cell6 = row.insertCell(6);
					cell6.innerHTML=data[i]['seat_no'];
				});
			},
			error:function(){
				alert("error");
    	...
    	<div style="width: 600px;height: 500px;float: left;margin-left: 3px">
    		<table id="jdpcTable" width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_list">
    			<tr class="title_font" onclick="tdclick()">
					...
					<td width="15%" align="center" bgcolor="#C7E2F8"><span class="out">考生姓名</span></td>
					...
					<td width="15%" align="center" bgcolor="#C7E2F8"><span class="out">单位名称</span></td>
					<td width="15%" align="center" bgcolor="#C7E2F8"><span class="out">考场名称</span></td>
					<td width="15%" align="center" bgcolor="#C7E2F8"><span class="out">座号</span></td>
				</tr>
    		</table>
    	</div>
    </div>
