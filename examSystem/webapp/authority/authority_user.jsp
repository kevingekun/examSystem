...
<body class="nrbj">
<table width="95%" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px; margin-left:8px; ">
  <tr>
    <td width="45%" align="left"><table border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td  align="left" valign="middle" class="header1"></td>
        <td  class="header2">用户：<s:property value="euser.username"/></td>
        <td  class="header3"></td>
      </tr>
    </table></td>
...
<s:form name="aForm" action="updateAuthUser.action" method="post" onsubmit="return save();">
