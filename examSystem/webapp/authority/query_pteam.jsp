            ...
            <td class="borader3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <s:form action="updateTeam.action"  namespace="popedom" name="aForm" method="POST">
              	<table align="center">
              		...
              		<tr>
              			<td>联&nbsp;系&nbsp;人:</td>
              			<td><input type="text" name="contactname" value="<s:property value="userteam.contactname"/>"></td>
              		</tr>
              		<tr>
              			<td>联系电话:</td>
              			<td><input type="text" name="contactph" value="<s:property value="userteam.contactph"/>"></td>
              		</tr>
              		<tr>
              			<td>地&nbsp;&nbsp;&nbsp;址:</td>
              			<td><input type="text" name="teamaddress" value="<s:property value="userteam.teamaddress"/>"></td>
              		</tr>
              		<tr>
              			<td>考场人数:</td>
