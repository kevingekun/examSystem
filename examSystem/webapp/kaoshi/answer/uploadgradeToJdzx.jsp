...
<table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" style="margin-top:10px; margin-left:8px; ">
  ...
  <tr>
                ...
                <tr>
                  <td class="borader3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <s:form action="uploadgradeToJdzx.action"  name="aForm" method="POST">
                          <tr>
                          ...
                          <tr>
                            ...
                            <td width="15%" align="left"><s:textfield name="eUser.username" /></td>
                            <td width="10%" height="28" align="right">考生姓名：</td>
                            <td width="15%" align="left"><s:textfield name="eUser.realname" /></td>
                            <td>&nbsp;</td>
                          </tr>
                        </s:form>
                      </table>
                  ...
                  <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="header8">
                        	...
                        	<a id="aUpload" href="#" class="btn_upload" onclick="upload('<c:out value="${sjMc}"/>','<c:out value="${sjid}"/>')">
                        		<font style="color: red;">上传</font>&nbsp;<c:out value="${sjMc}"/>&nbsp;<font style="color: red;">到鉴定中心</font>
                        	</a>
                        </td> 
                      </tr>
                  </table></td>
	...
	<c:if test="${list!= null }">
              <!-- fenye -->
  	<form action="uploadgradeToJdzx.action" name="answerpaperpmqueryForm" method="post" style="margin-top: 6px;">
