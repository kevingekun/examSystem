...
<%
	...
	EUser user=(EUser)request.getAttribute("euser");
...
function show(m, obj) {
	...
	doAction("policy_list.jsp?nodeid="+m);
}
...
menusite<%=nodeBase.getId()%>[1] = '<tr onmouseover=javascript:this.style.background="#B6C9D8" onmouseout=javascript:this.style.background="#E0E9F1" onclick=doAction("policy_list.jsp?nodeid=<%=nodeBase.getId()%>")  class="word10"><td style="height:16px; cursor:hand" ></td></tr>'
