...
String fileUrlPath = "../libstore/policy/1/";

//System.out.println("libstore====>"+fileUrlPath);
String fax = "";
String name = "";
AbstractTree t = FactoryBean.creator("policy");
PolicyNode fathernode = null;
if(fileid!=null&&fileid.length()>0&&!fileid.equals("null")){
 fathernode = (PolicyNode)t.getNodeById(Node.getNodeType("policy"),new Long(fileid.substring(0,fileid.length()-5)));
 }
if (fathernode!=null&&fathernode.getAttribute().getFaxFile() != null) fax = fathernode.getAttribute().getFaxFile();
			...
			setscfm.submit();
                ...
                <tr>
                  <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td  class="header8">历史记录&nbsp; &nbsp;<a href="#" onclick="history.back(1)"><img src="<%=request.getContextPath()%>/kaoshi/images/ico/point2_15px.gif" alt="后退" width="15" height="11" border="0" /></a>
              ...
              <table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_list" id="tb" >
                <tr onmouseover="this.className='td_over'" onmouseout="this.className=''" id="r1">
                 	<script>
									if (ReadCookie("ID") == ""){
										document.write("<tr  onmouseover=this.className='td_over' onmouseout=this.className='' id='r1' width='33%'>");
										document.write("<td>");
										document.write("&nbsp;");
										document.write("</td>");
									...
									if (ReadCookie("ID") == "2"){
										document.write("<tr  onmouseover=this.className='td_over' onmouseout=this.className='' id='r1' width='33%'>");
										document.write("<td>");
										document.write("<a href = <%=fileUrlPath%>" + ReadCookie("item1link") + " target=_self>");
										document.write(ReadCookie("item1"));
										document.write("</a>");
										document.write("</td>");
										document.write("<td width='33%'>");
										document.write("<a href = <%=fileUrlPath%>" + ReadCookie("item2link") + " target=_self>");
										document.write(ReadCookie("item2"));
										document.write("</a>");
										document.write("</td>");
										document.write("<td width='34%'>");
										document.write("<a href = <%=fileUrlPath%>" + ReadCookie("item3link") + " target=_self>");
										document.write(ReadCookie("item3"));
										document.write("</a>");
										document.write("</td>");
										document.write("</tr>");
									}
                 ...
                 <%
										...
										if (policy != null){
											for (Enumeration e = policy.keys(); e.hasMoreElements();) {
												...
												out.print("<a title="+policy.get(obj)+" href='law_file.jsp?fileid=" + (String)obj + "&filename=" + policy.get(obj) + "&&selectitem="+(String)obj.toString().substring(0,u.length()-5)+"' target=_self>");
