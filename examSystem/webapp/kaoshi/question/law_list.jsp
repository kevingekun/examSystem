...
<%
		String selectitem = request.getParameter("selectitem");	//当前选项
              ...
              <tr> 
                ...
                <td  colspan="2" valign="top"> 
                  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#E0F0FD">
                    <tr bgcolor="#FFFFFF"> 
                      <td width="30%" height="23"><div align="center">文件编号</div></td>
                      <td width="70%"><div align="center">标 题 </div></td>
                    </tr>
                    <tr bgcolor="#FFFFFF"> 
