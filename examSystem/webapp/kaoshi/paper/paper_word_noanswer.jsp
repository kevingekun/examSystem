...
.txtBox1 
{
	...
	FONT-SIZE: 12px; 
	BACKGROUND-IMAGE: url(../../../../星空急速/星空急速/css/images/txtbox_shadow.gif); 
	BORDER-LEFT: #464646 1px solid; 
	COLOR: #282828; BORDER-BOTTOM: #464646 1px solid; 
	FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; 
...
.data_button
	{
		...
		COLOR: #0E3299; 
		PADDING-TOP: 2px; 
		BORDER-BOTTOM: #73B5F2 1px solid; 
		TEXT-DECORATION: none
...
<div class="title title_yl"><h1><c:out value="${pager.sjMc}"/></h1></div>		
	<table width="90%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#EAF4FD">
          <tr bgcolor="#FFFFFF">
            <td>试卷名称 : </td>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="10" style="font-size:12px;font-family:宋体; border:solid 1px #D2E8FF">								
		<tr>
		 <td style="color:#004A80;font-family:'黑体'; font-size:18px">
				<%=arry1[zl-1] %>、&nbsp;<s:property value="#type.name"/>&nbsp;（共<s:property value="#epaperquestions.size"/>题,
				共<SPAN id='<s:property value="#type.id"/>fenshuSpan'><script type="text/javascript">retrieveBook('<s:property value="#type.id"/>fenshuSpan','<s:property value="#type.id"/>');</script></SPAN>分）
		 ...
		 <td style="font-weight:bold; padding-left:45px;">
				...
				<s:if test="%{#priority==2  ||  #priority==8}">
					...
					<s:iterator status="wenti">
                       <tr><td style="color:#555; padding-left:60px;"><input type="checkbox"><s:property value="#request.arry[#wenti.index]" /> .
							 	<s:property /></td></tr>
					</s:iterator>
					</s:generator>
					<!-- 答案 -->
				...
				<tr>
				    <td style="color:#555; padding-left:60px;"><input type="radio">正确  <input type="radio">错误</td>
				 </tr>
				 </s:elseif>
				 ...
				 <tr>
				    <td valign="top" style="padding-left:60px; height:100px;">
				    	说明：
				    </td>
				  </tr>
				  <tr>
