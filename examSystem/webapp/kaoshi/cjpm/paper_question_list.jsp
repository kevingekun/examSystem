...
<script type="text/javascript">
	function jumpback(){
		...
		document.aForm.action="answerpaperpmquery.action";
...
<table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" style="margin-top:10px; margin-left:8px; ">
  ...
  <tr>
    <td colspan="2" valign="top" ><div id="content1" class="borader">
              ...
              <s:form action="ecjpmquestion" name="aForm" method="post">
                <s:hidden name="sjid" />
                <tr>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:12px;">
        ...
        <table  width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_list" id="tb" >
             <tr class="title_font">
                ...
                <td  align="center" bgcolor="#C7E2F8"><span class="out">业务类型</span></td>
                ...
                <td  align="center" bgcolor="#C7E2F8"><span class="out">文号</span></td>
                <td  align="center" bgcolor="#C7E2F8"><span class="out">录入时间</span></td>
                <td  align="center" bgcolor="#C7E2F8"><span class="out">修改时间</span></td>
             </tr>
          <s:iterator value="lis" id="epaper" status="index">
            <tr onMouseOver="this.className='td_over'" onMouseOut="this.className=''" id='r1'>
                ...
                <s:property value="#epaper.equestions.stWh"/>
               </td>
	            <td align="center">
	            	<s:date name="#epaper.equestions.stLrsj" format="yyyy-MM-dd HH:mm"/>
	            </td>
	            <td align="center">
	            	<s:date name="#epaper.equestions.stXgsj" format="yyyy-MM-dd HH:mm"/>
	            </td>
            </tr>       
         </s:iterator>
	</table>
	<s:form name="queryform1" method="post" action="ecjpmquestion">
		 <s:hidden name="sjid" />
    	 <s:hidden  name="stTg" />
         ...
         <elile:navigateBar navigateform="navigateform" actionName="ecjpmquestion.action" formName="queryform1"/>
    </s:form> 
    	   </td>
    </tr>
