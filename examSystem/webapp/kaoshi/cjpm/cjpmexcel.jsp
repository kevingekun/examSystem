...
<table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" style="margin-top:10px; margin-left:8px; ">
    <tr>
      <s:iterator value="sjMc" id="ap" status="status"></s:iterator>
         <td align='center'>
         	<font color="red">
         		<s:property value="#ap"/>:
         	</font>考试成绩排名表
         ...
         <table  width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_list" id="tb" >
            ...
            <s:iterator value="gradeList" id="answerpaper" status="status">
	            <tr onMouseOver="this.className='td_over'" onMouseOut="this.className=''" id='r1'>
	             ...
	             <td align='center' class='num_font'><s:property value="#answerpaper[0]"/></td>
	             <td align='center' class='num_font'><s:property value="#answerpaper[1]"/></td>
				 ...
				 <td align='center' class='num_font'><s:date name="#answerpaper[4]" format="yyyy-MM-dd HH:mm:ss"/></td>
	     	     <td align='center' class='num_font'><s:date name="#answerpaper[5]" format="yyyy-MM-dd HH:mm:ss"/></td>
	             <td align='center' class='num_font'><s:property value="#answerpaper[6]"/></td>
	 			 <td align='center' class='num_font'>
		 			 <c:choose>
						<c:when test="${answerpaper[7]=='0'}">未作弊</c:when>
	...
	<%-- <c:if test="${epapers!= null }">
  	<s:form action="answerpaperpmquery.action" name="answerpaperpmqueryForm" method="post">
        ...
        <tr>
        	<td width="20%" align="left">本次参考人数:<s:property value="all"/>&nbsp;&nbsp;&nbsp;&nbsp;不及格人数:<s:property value="unpass"/>&nbsp;&nbsp;&nbsp;&nbsp;平均分：<s:property value="average"/>&nbsp;&nbsp;&nbsp;&nbsp;合格率：<s:property value="percent"/>%</td>      
        </tr>
   </table>
</body>
</html>  		 