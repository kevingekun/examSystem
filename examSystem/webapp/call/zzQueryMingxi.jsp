...
<html>
	...
	request.setCharacterEncoding("UTF-8");
 	...
 	//name = "";
		...
		String groupname="";
		String groupid="";
		if(gonghao.equals("5504")){
		groupname="第一组";
		groupid="2";
		}else if (gonghao.equals("5507")){
		groupname="第二组";
		groupid="3";
		}else if (gonghao.equals("5501")){
		groupname="第三组";
		groupid="4";
		}else if (gonghao.equals("5502")){
		groupname="第四组";
		groupid="5";
		}else if (gonghao.equals("5509")){
		groupname="第五组";
		groupid="6";
		}else if (gonghao.equals("5505")){
		groupname="第六组";
		groupid="7";
		}
	...
	<body>
	<form name="queryform" method="post" action="zzQueryMingxi.jsp">
	...
	<table width="100%" border="0" align="center" cellpadding="3"
		cellspacing="1" bgcolor="#9CDBF6">
			...
			<tr bgcolor="#FFFFFF">
				<td height="1" colspan="7" bgcolor="#C9ECFA"></td>
			</tr>
			...
			List list3=null;
			if(mutex.equals("1")){
			//list2 = pit.findTopHistory1(prepage,nextpage);
			//}
			//else {
			list2=pit.zzQueryMingxi(groupid,username,callid,starttime,endtime,start,end,prepage,nextpage);
			...
			if(list2!=null&&list2.size()!=0){
				...
				if( pf!=null&&pf.getDafenmemo() != null ){
	              ...
	              countcs=rec2.getModifycs();
					...
					out.println("<td align=center>");
					out.println("<a class='b' href=luyin1.jsp?callid="
