...
<%
	 String gonghao=((UserDetailsImpl)util.getUserDetails()).getUser().getUsername().toString();
	   ...
	   request.setCharacterEncoding("utf-8");
		...
		String weitiaoreason=request.getParameter("weitiaoreason");
		String callid=request.getParameter("callid");
		String A=request.getParameter("A");
		 if (A==null||A.equals(""))
		  A = "";
		//  if(A.equals("1")){
			 pit.replace1(callid,weitiaoreason);
		//	 if(temp!=null&&temp.size()!=0){
				
					
		//			Set messageusers = new HashSet();
		//			Message msg = new Message();
		//			msg.setTitle("系统提示：质检微调申请"); 
		//			msg.setContentstring("系统提示：质检微调申请"); 
 ...
 %>
				...
				<div align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
		            	<tr> 
			                ...
			                <td align="center"><strong> &nbsp;<font size=3>微调申请单</font></strong>
	...
	<table width="60%" height=200 border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#84B7C6">
	  ...
	  <tr bgcolor="#ffffff">
		  	<td valign="middle"><div align="center" >微调申请理由：</div></td>
		  	<td colspan="3"><TEXTAREA id=weitiaoreason name=weitiaoreason rows=10 cols=55 style="overflow:auto" ></TEXTAREA></td>
		</tr>
