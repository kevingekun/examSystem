...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" valign="top"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#CCCCCC">
					...
					out.print(pn1.getName()+"("+pn1.getValue()+"%)</td>");
          			...
          			out.println("</script>");
						...
						for(int k=0;k<subtree1.size();k++){
							...
							out.print("<td bgcolor='#ffffff'><input type='radio' name=radio"+pn2.getId()+" value=4>好<input type='radio' name=radio"+pn2.getId()+" value=3>较好<input type='radio' name=radio"+pn2.getId()+" value=2>一般<input type='radio' name=radio"+pn2.getId()+" value=1较差<input type='radio' name=radio"+pn2.getId()+" value=0>差&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>");
							out.print("<tr><td height='3' colspan='3' background='images/dot_line.gif' bgcolor='#FFFFFF'></td></tr>");
      ...
      <tr>
      <%if(!auth.equals("015")){ %>
        <td bgcolor="#EAF8FD" align=center><strong><input type=button value=打分 class=smallbutton onclick="javascript:dafen1();"></td>
        <%} %>
