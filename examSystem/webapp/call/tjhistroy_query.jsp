...
<html>
	...
	<body>
	<form name="queryform" method="post" action="tjhistroy_query.jsp">
	...
	<table width="100%" border="0" align="center" cellpadding="3"
		cellspacing="1" bgcolor="#9CDBF6">
			...
			List list3=null;
			if(mutex.equals("")){
			list2 = pit.findTopHistory2(name,prepage,nextpage);
			}
			else {
			list2=pit.findHistory2(username,callid,starttime,endtime,start,end,name,prepage,nextpage);
			...
			if(list2!=null&&list2.size()!=0){
				...
				if( pf!=null&&pf.getDafenmemo()!= null ){
					 ...
					 //System.out.println("dafenmemo===>"+dafenmemo);
					}
                   String dianxingflag="";
                    dianxingflag=hospital.getDianxingflag();
                    if (dianxingflag==null||dianxingflag.equals(""))
				     dianxingflag = "";
						
					out.println("<tr bgcolor=\"#FFFFFF\">");
					out.println("<td align=center>");
					out.println("<a href=manualcall_log.jsp?id="
					...
					out.println("</td>");
					if(dianxingflag.equals("1")||dianxingflag.equals("2")||dianxingflag.equals("3")){
					...
					out.println("</td>");
					out.println("<td align=center>");
					out.println("<a href=applymodify.jsp?callid="
