...
<%
	...
	String servicetype = "";
	RECORDORIGINALDATA h = his.getByGonghaoPhoneid(callid);
	Summary hh = his.getBySummaryid(callid);
	...
	if(h!=null){
		...
		comments = hh.getSummary() == null ? "" : hh.getSummary();
		startime = h.getStartrecordtime()==null?"": h.getStartrecordtime().toString();
		endtime = hh.getEventtime() ==null?"":hh.getEventtime().toString();
	}
%>
	<%
