				...
				<table border=0>
					...
					String agentid = "";
						for (Iterator lt = urllist.iterator(); lt.hasNext();) {
							...
							agentid=array[3];
							user = userDAO.getUserByEx(array[4]);
							out.println("<tr>");
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<legend>历史记录查看</legend>
		...
		<tr>
        <td bgcolor="#EAF8FD" align=center><strong><input type=submit value=打分 class=smallbutton></td>
        <td bgcolor="#EAF8FD" align=center><strong><a href="javascript:history.back(0)" class="bg"><img src="images/bt_fh.gif" width="48" height="21" border="0" /></a></strong></td>
