...
<title></title>
<link href="inc/style.css" rel="stylesheet" type="text/css"></link>
...
window.onload=function(){ 
	document.getElementById('j_username_id').focus();
}
</script>
</head>
...
request.getSession().setAttribute("state", "admin");
%>
...
<div class="login_box">
   ...
   <div class="login_show">
    <ul>
      <li>
        <input type="text" class="login_one" name="j_username" id="j_username_id" />
      </li>
      <li>
        <input type="password"  class="login_two" name="j_password" id="j_password_id" />
      </li>
      <li style="padding-top:15px;">
      	<a href="#" class="login_dl" onclick = "document.forms['Lgin'].submit();">
      		<span class="color_white">登录</span>
      	</a>
		<a href="#" class="login_cz" onclick = "document.forms['Lgin'].reset();">
			<span class="color_white">重置</span>
		</a>
	</li>
     <li><c:if test="${not empty param.login_error }">
     	<font color="red" size="2"> 登录失败请重新输入</font></c:if>
     </li>
    </ul>
  </div>
</div>
