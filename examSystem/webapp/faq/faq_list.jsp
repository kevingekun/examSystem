...
<SCRIPT language=JavaScript>
	...
	var self =document.getElementById("chuti").value;
...
-->
	...
	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:12px;">
		...
		<table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="tb" >
			...
			<%
			int n = 0;
			FaqNode pn1 = new FaqNode();
			%>
			<c:forEach var="aBean" items="${pagelist}" varStatus="status">
											<%
												n++;
												pn1 = (FaqNode)pagelist.get(n-1);
											...
											<tr onmouseover=this.className='td_over' onmouseout=this.className='' id='r1' bgcolor="<%=n != n / 2 * 2 ? "#ebf3f6" : "#ebf3f6"%>"
												...
												<td  class='num_font' height="30" valign="middle" nowrap="nowrap">
												&nbsp;&nbsp;&nbsp;&nbsp;
											<!-- 	<a href="<%=request.getContextPath()%>/toViewWdzl.action?cname=faq&docid=<%=pn1.getId() %>" title="" >  -->
												<a href="\\168.30.1.54\c$\Program Files\IBM\WebSphere\AppServer\profiles\AppSrv01\installedApps\yibao-cd3ed4aedNode01Cell\falnew_war.ear\falnew.war\libstore\ansq\<%=pn1.getAttribute().getHtmlFile() %>" title="\\168.30.1.54\c$\Program Files\IBM\WebSphere\AppServer\profiles\AppSrv01\installedApps\yibao-cd3ed4aedNode01Cell\falnew_war.ear\falnew.war\libstore\ansq\<%=pn1.getAttribute().getHtmlFile() %>" target="_blank" >
													<span class="">
															<font
        ...
        <tr>
          <td align="center" valign="middle" class="num_font"><div class="page1_box">
          		<form name="queryform" action="<%=request.getContextPath()%>/faq/faq_list.jsp" method="post">
						...
						<c:if test="${pagelist!= null}">
							<elile:navigateBar navigateform="navigateform"
								actionName="/falnewexam/faq/faq_list.jsp" formName="queryform" />
						</c:if>
					</form>
          </div></td>
        </tr>
