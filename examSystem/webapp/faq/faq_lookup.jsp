...
<link href="../inc/all.css" rel="stylesheet" type="text/css">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form method = "post" action = "faq_lookup.jsp" name="lookup">
          ...
          <tr> 
            ...
            <td><input name="keyword" type="text" size="20"></td>
            <td nowrap align="center">标题：</td>
            <td nowrap><input name="title" type="text" size="20"></td>
										...
										if (request.getParameter("keyword") != null){
											...
											//out.print(l.size());
												for (Iterator it = l.iterator(); it.hasNext();) {
													FaqNode tmp = (FaqNode) it.next();
													//out.println(tmp.getId());
													out.println("<tr bgcolor=\"#FFFFFF\"> ");

														//out.println("<td>&nbsp;</td>");
													out.println("<td align=left><a href=faq_file.jsp?fileid=" + tmp.getAttribute().getHtmlFile() + "&id=" + tmp.getId() + " target='_self'>" + tmp.getName() + "</a></td>");
													out.println("</tr>");
												}
										}
										%>
