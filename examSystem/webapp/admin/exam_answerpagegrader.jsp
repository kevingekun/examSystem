						...
						<% 
							...
							System.out.println("set.size()===>>>>>>>>>>>>>>"+set.size());
								for(int i=0;i<set.toArray().length;i++){
									...
									//if(ea.getExamanswerstatus().getStatusname().equals("未审阅")){
										...
										if(ea.getExamanswerstatus().getStatusname().equals("未审阅")){																
											out.println("<td><a class=b href='exam_answerentitygrader.jsp?examanswerid="+ea.getExamanswerid()+"&username="+ea.getUsername()+"'>点击审阅</a></td>");									
										}else{
