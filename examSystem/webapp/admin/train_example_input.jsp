...
<HTML>
	...
	<script>
		...
		function checkSubmit(){
			if(document.trainexampleform.title.value==""){
				alert("请填写标题！");
				return ;
			}
			if(document.trainexampleform.content.value==""){
				alert("请填写内容！");
				return ;
			}			
			if(document.trainexampleform.example.value==""){
				alert("请至少一个案例！");
				return ;
			}				
			document.trainexampleform.submit();
	...
	<% 
	%>
	<form name="trainexampleform" method="post" action="<%=request.getContextPath() %>/trainexampleservlet" >
	...
	<tr> 
		<td bgcolor="#FFFFFF" height="495" valign=top align=center>
			<table width="80%" border="0" align="center" cellpadding="1" cellspacing="2">
				...
				<tr id="fujian" >
						<td align=right>案&nbsp;&nbsp;&nbsp;&nbsp;例：</td>	
						<td >
							<input type=text name="example" size=60 value="">
							<input type=hidden name="realquesid" value="">
							&nbsp;
							<a href=# onclick="window.open('train_example_newwindow.jsp')">添加</a>
						</td>	
					</tr>				
				<tr>
