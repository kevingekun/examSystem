	...
	<tr>
    	<td>
    		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      		...
      		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" >
        		<tr> 
          			<td width="177" valign="top" background="../images/lf_03.gif" bgcolor="#FFFFFF"><img src="../images/lf_01_2.gif" width="134" height="32"> 
            			<table width="95%" border="0" cellpadding="0" cellspacing="0">
              				<tr> 
                				<td >
                					<jsp:include page="exam_answerpaper_manage_left.jsp"/>
            					</td>
              				</tr>
            			</table>
          			</td>
          			...
          			<td valign="top" bgcolor="#FFFFFF"> 
		  				<iframe  id="frm" src="exam_answerpaper_query.jsp" width="100%" height="584" scrolling="auto" frameborder="0"></iframe>
					</td>
