						...
						<% 
							if(list!=null){
								for(int i=0;i<list.size();i++){
									...
									out.println("<td><a class=b href='examQuery.jsp?examid="+ep.getExamid()+"'>预览</a></td>");
									out.println("<td><a class=b href='examdelete.jsp?examid="+ep.getExamid()+"'>删除</a></td>");
								}
							}
						%>
