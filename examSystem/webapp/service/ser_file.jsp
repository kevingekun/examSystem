...
String fileUrlPath = "../"+pu.getProperties("path.fabu.url")+"service/"+user.getUserType()+"/";
...
if(fileid!=null&&fileid.length()>0&&!fileid.equals("null")){
 fathernode = (ServiceNode)t.getNodeById(Node.getNodeType("service"),new Long(fileid.substring(0,fileid.length()-5)));
 }
...
<iframe name=roll4  src='<%=fileUrlPath%><%=fileid%>' width="100%" height="75%" Frameborder=0 Border=0 Marginwidth=0 Marginheight=0 Scrolling=auto></iframe>
<form method = "post" action = "service_list.jsp" name="list">
