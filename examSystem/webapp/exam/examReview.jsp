...
<script type="text/javascript">
	...
	function changeTopage(){
		//parent.frames.topFrame.location="<%=request.getContextPath()%>/top.jsp";
	}
</script>
<%  
	ExamAnswers examanserpager = (ExamAnswers)request.getAttribute("examanserpager");
	ExamAnswers realandwerpage;
	if(examanserpager==null){
 		String examanswerid = request.getParameter("examanswerid");	
		realandwerpage = examservice.finAnswerPaperById(examanswerid);
	}else{
		realandwerpage = examservice.finByPaperAndUser(examanserpager.getExampaper(),examanserpager.getUsername()); 	
	}
...
<TABLE border=0 align=center width=100% height=100% cellpadding=1 cellspacing=1 bgcolor="#D2E8FF">
	...
	<tr bgcolor="#ffffff">
		<td align=left>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a class=b href="#" onclick="history.back(1)" >返回</a>
		</td>
	</tr>	
	<TR bgcolor="#ffffff">
		<TD>
