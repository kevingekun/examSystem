  	...
  	<tr> 
	    ...
	    <td  colspan="2" valign="top"> 
			<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#E0F0FD" id="tables">
		        ...
		        <tr bgcolor="#FFFFFF"> 
		          <td height="5" colspan="5" bgcolor="#F1F8FE"></td>
		        </tr>
		        <% 
			    	if(list!=null){
				...
				%>
					<tr bgcolor="#FFFFFF"> 
					    ...
					    <td ><%=ep.getExamname() %></td>
					    <td align=center><%=ep.getEffectstarttime().toString().substring(0,10)%></td>				    
					    <td align=center><a href="exam_scorerange.jsp?exampaperid=<%=ep.getExamid()%>">查看排名</a></td>						    
					</tr>					
				<%	
						}	
					}        	
