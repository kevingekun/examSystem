...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
		...
		<td width="98%" background="../images/k1_03.gif">公告&nbsp;	
	    ...
	    <td  colspan="2" valign="top"> 
			<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#E0F0FD" id="tables">
		        <tr bgcolor="#FFFFFF"> 
					...
					<td width="15%"><div align="center">考试名</div></td> 
					<td width="15%"><div align="center">发送者</div></td> 
				...
				<tr bgcolor="#FFFFFF"> 
				    ...
				    <td align=center><a href="examonenotice.jsp?eaid=<%=ea[0] %>" >查看</a></td>						    
				</tr>			        
		       	<% 
		        	}
		        %>
