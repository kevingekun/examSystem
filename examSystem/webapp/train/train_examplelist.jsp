...
<% 
	...
	List list = tfs.findTrainExample(0,10);
%>
<HTML>
	<HEAD>
			 ...
			 <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#E0F0FD">
					...
					<% 
						for(int i=0;i<list.size();i++){
							TrainExample tf = (TrainExample)list.get(i);
					%>
					<tr bgcolor=#ffffff>
						...
						<td align=center width=100><a href="train_examplequery.jsp?tfid=<%=tf.getId() %>" >查看</a></td>		
					</tr>
					<%
						}						
					%>
