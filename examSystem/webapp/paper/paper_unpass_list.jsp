...
<script language="JavaScript" type="text/JavaScript" src="<%=request.getContextPath()%>/js/date2.js"></script>
							...
							<td class="borader3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<form action="<%=request.getContextPath()%>/papersServlet" name="aForm" method="POST">
									<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
										<input type=hidden name="actionType" value="queryUnpass">
										<input type=hidden name="sjZt" value="5">
										...
										<tr>
											<%--<td align="center" colspan="4"><input name="button" type="button" class="submit_2" onClick="javascript:doQuery();" value="查询" />
                   			</td>
                          --%>
										</tr>
									...
									<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_list" id="tb">
										...
										<c:forEach var="aBean" items="${list}" varStatus="status">
											<tr onMouseOver="this.className='td_over'" onMouseOut="this.className=''" id='r1'>
												...
												<td align="center">
													<button class="SmallButton" onclick='jumpViewPaper(<c:out value="${ aBean.sjId}"/>);'>修改</button>
												</td>
											</tr>
										</c:forEach>
									</table> <!--   分页       --> 
