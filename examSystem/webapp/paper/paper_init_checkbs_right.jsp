								...
								<td height="26" colspan="8" align="center">
									<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablistys">
										<tr class="row_height">
											...
											<td width="18%"><input type="text" readonly="true" name="gzMc" value="<%=t.getJobname()%>" id="gzmc" class="input1" style="float: left;"> <font color="#FF0000" style="float: right;">*</font></td>
											<td width="10%" align="right">等级：</td>
											<td width="18%"><select id="grade" name="grade" onchange="showDrade(this.value)" style="width: 100px">
											...
											<td width="20%"><input type="text" name="sjMc" value="" id="sjmc" class="input1" style="float: left;"> <input type="hidden" name="sjMcc" id="sjMcc" /> <font color="#FF0000" style="float: right;">*</font></td>
											<td align="left"><input type="button" class="submit_2" onClick="javascript:scsj();" value="生成试卷" /></td>
										</tr>
										<tr>
											...
											<td><input type="text" name="sjBhgfs" value="60" class="input1" style="float: left;" /> <font color="#FF0000" style="float: right;">*</font></td>
										...
										<tr>
											...
											<td width="15%" align="right">有效期至：</td>
