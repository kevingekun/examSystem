...
<form name="addform" action="<%=request.getContextPath() %>/QuestionServlet" method="post">
 ...
 <input type=hidden name="myaction" value="modify_again">
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" >
                ...
                <tr>
			        ...
			        <td align="right">试题性质：</td>
			        <td><input type=radio name="ST_KSZY" value="1" <c:if test="${question.stKszy==1}">checked</c:if>>考试题
						  <input type=radio  name="ST_KSZY" value="2" <c:if test="${question.stKszy==2}">checked</c:if>>阶段性试题
						  </td>
                </tr>
                <tr>
			        <td height="26" align="right">出处：</td>
			        <td colspan=3><input type=text id="ST_CC" name="ST_CC" value="<c:out value="${question.stCc}" />" style="width:662px" readonly></td>
			     </tr>
			     <tr>  
			        <td height="26" align="right">文号：</td>
			        <td colspan=3><input type=text id="ST_WH" name="ST_WH" value="<c:out value="${question.stWh}"/>" style="width:662px" readonly></td>
                </tr>																
...
<div id="div8" <c:if test="${question.equestiontype.id!=8}"> style="display:none"</c:if>>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" >
		...
		<div id="div9" <c:if test="${question.equestiontype.id!=9}"> style="display:none"</c:if>>
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0"><tr>
							  <td><textarea name="calculatekey" id="calculatekey" style="width:580px;" rows="5"><c:if test="${question.equestiontype.id==9}"><c:out value="${question.stDa}"/></c:if></textarea></td>
								<td>&nbsp;</td>
								<td></td></tr>
							</table>
						</td>
...
<div id="div10" <c:if test="${question.equestiontype.id!=10}"> style="display:none"</c:if> >
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" >
		<tr>
		...
		<div id="div11" <c:if test="${question.equestiontype.id!=11}"> style="display:none"</c:if>>
															...
															<tr>
																<td>
																	<textarea name="discusskey" id="discusskey"
																		style="width: 750px; height: 50px;"><c:if test="${question.equestiontype.id==11}"><c:out value="${question.stDa}"/></c:if></textarea>
																</td>
																<td>
																	&nbsp;
																</td>
					...
					<div id="div12" <c:if test="${question.equestiontype.id!=12}"> style="display:none"</c:if>>
								<table width="99%" border="0" align="center" cellpadding="0"
									cellspacing="0">
									<tr>
										<td width=40% colspan="2">
															...
															<tr>
																<td>
																	<textarea name="databasekey" id="databasekey"
																		style="width: 750px; height: 50px;"><c:if test="${question.equestiontype.id==12}"><c:out value="${question.stDa}"/></c:if></textarea>
																</td>
																<td>
																	&nbsp;
																</td>
...
<div id="div13" <c:if test="${question.equestiontype.id!=13}"> style="display:none"</c:if>>
								<table width="99%" border="0" align="center" cellpadding="0"
									cellspacing="0">
									<tr>
										<td width=40% colspan="2">
															...
															<tr>
																<td>
																	<textarea name="telephonekey" id="telephonekey"
																		style="width: 750px; height: 50px;"><c:if test="${question.equestiontype.id==13}"><c:out value="${question.stDa}"/></c:if></textarea>
																</td>
																<td>
																	&nbsp;
																</td>
