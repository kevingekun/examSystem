  ...
  <tr>
    <td colspan="2" valign="top" ><div id="content1" class="borader">
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<form name="queryform" method="post" action="jiqiaodianxingQuery.jsp">
...
if(name.equals("061")&&mutex.equals("")){
		...
		Date date = new Date();
			...
			List list2=null;
			List list3=null;
			list2=pit.jiqiaodianxingfindHistory1(sort,type,username,callid,starttime,endtime,start,end,currpage,pagesize);
			list3=pit.jiqiaodianxingfindHistory1(sort,type,username,callid,starttime,endtime,start,end,1,60000);
			...
			if(list2!=null&&list2.size()!=0){
			 ...
			 db.close();		
					...
					out.println("</td>");
						out.println("<td align='center'>");
					String realname2="";
					if(hospital.getDafenren4()!=null){
					User user1=udao.getUserByUsername(hospital.getDafenren4());
					realname2=user1.getRealname();}
					out.println(StringUtils.trimToEmpty(realname2));
					out.println("</td>");
					out.println("<td align='center'>");
					out.println("<a  href=jiqiaodelete.jsp?callid="
							+ hospital.getId() + " target=\"_self\">"+
							"删除 </a>");
					out.println("</td>");
		...
		<form name="queryform1" action="jiqiaodianxingQuery.jsp" method="post">
	 ...
	 <td align="center" valign="middle" class="num_font"><div class="page1_box">
			<elile:navigateBar navigateform="navigateform"
								actionName="jiqiaodianxingQuery.jsp" formName="queryform1" />	
								  </div></td>
        </tr>
	 </table>
