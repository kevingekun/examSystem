  ...
  var d=document; if(d.images){ if(!d.MM_p) d.MM_p=new Array();
    ...
    if (a[i].indexOf("#")!=0){ d.MM_p[j]=new Image; d.MM_p[j++].src=a[i];}}
		...
		function goto(i){
			switch(i){
				case 1:
					frm.location="question_add.jsp";break;		
				case 2:
					frm.location="question_query.jsp";break;							
			}
		}
  		...
  		<td>
        	<table width="100%" height="25" border="0" cellpadding="0" cellspacing="1" bgcolor="#9FBED8">
				...
				<tr bgcolor=#CEE7FC align=center height=30 onMouseOver="this.style.backgroundColor='#F2F8FE';this.style.fontSize='24px'" onMouseOut="this.style.backgroundColor='#CEE7FC'">
					<td>
						<b><a href="#"  onclick="goto(1)">&nbsp;<font color="#FE8652">试&nbsp;题&nbsp;录&nbsp;入</font></a></b>
					</td>
				</tr>	
				<tr bgcolor=#CEE7FC align=center height=30 onMouseOver="this.style.backgroundColor='#F2F8FE';this.style.fontSize='24px'" onMouseOut="this.style.backgroundColor='#CEE7FC'">
					<td>
						<b><a href="#"  onclick="goto(2)">&nbsp;<font color="#FE8652">试&nbsp;题&nbsp;管&nbsp;理</font></a></b>
					</td>
				</tr>					
         		<tr>
         			<td>
          			...
          			<td valign="top" bgcolor="#FFFFFF"> 
		  				<iframe  id="frm" src="question_add.jsp" width="100%" height="584" scrolling="auto" frameborder="0"></iframe>
					</td>
