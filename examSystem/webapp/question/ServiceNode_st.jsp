...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:12px;">
       ...
       <input type=hidden name="actionType" value="query">
        <input type=hidden name="myaction" value="modifyload_st">
          ...
          <s:iterator value="serviceNode_st" id="question" status="status">
    ...
    <s:form name="mypaperActionform" method="post" action="toView_Sst.action"> 		
         <input type="hidden" name="serviceNodeId" value="<s:property value='serviceNodeId'/>"/>
         <elile:navigateBar navigateform="navigateform" actionName="toView_Sst.action" formName="mypaperActionform"/>
	</s:form>
