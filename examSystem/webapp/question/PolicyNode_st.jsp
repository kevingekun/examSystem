...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:12px;">
       ...
       <input type=hidden name="actionType" value="query">
        <input type=hidden name="myaction" value="modifyload_st">
          ...
          <s:iterator value="policyNode_st" id="question" status="status">
    ...
    <s:form name="mypaperActionform" method="post" action="toView_st.action">
  		<input type="hidden" name="policyNodeId" value="<s:property value='policyNodeId'/>"/>
         <elile:navigateBar navigateform="navigateform" actionName="toView_st.action" formName="mypaperActionform"/>
	</s:form>
