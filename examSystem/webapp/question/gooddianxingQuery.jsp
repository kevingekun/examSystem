...
<%@ page import="com.wondersgroup.falcon.persistence.DBConnection"%>
	...
	int pagesize = RequestUtils.getInt(request, "pagesize", 10);//默认行行数 pagesize
  ...
  <tr>
    <td colspan="2" valign="top" ><div id="content1" class="borader">
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<form name="queryform" method="post" action="gooddianxingQuery.jsp">
...
<%
		...
		Date date = new Date();
			...
			list2=pit.gooddianxingfindHistory1(sort,type,username,callid,starttime,endtime,start,end,currpage,pagesize);
			list3=pit.gooddianxingfindHistory1(sort,type,username,callid,starttime,endtime,start,end,1,60000);
		...
		request.setAttribute("navigateform", navigateform);
			if(list2!=null&&list2.size()!=0){
			 ...
			 db.close();	
					...
					out.println("<td align='center'>");
					out.println("<a  href=gooddelete.jsp?callid="
							+ hospital.getId() + " target=\"_self\">"+
							"选择 </a>");
					out.println("</td>");
		...
		<form name="queryform1" action="gooddianxingQuery.jsp" method="post">
	 ...
	 <td align="center" valign="middle" class="num_font"><div class="page1_box">
			<elile:navigateBar navigateform="navigateform"
								actionName="gooddianxingQuery.jsp" formName="queryform1" />	
								  </div></td>
        </tr>
	 </table>
