      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<form name="queryform" method="post" action="yewuerrordianxingQuery.jsp">
...
<%
	...
	String zhijianid="";
		if(name.equals("061")){
			...
			list2=pit.yewuerrordianxingfindHistory1(sort,type,username,callid,starttime,endtime,start,end,currpage,pagesize);
			list3=pit.yewuerrordianxingfindHistory1(sort,type,username,callid,starttime,endtime,start,end,1,60000);
		...
		request.setAttribute("navigateform", navigateform);
			...
			navigateform.setTotal(list3.size());
			 ...
			 db.close();			
					...
					out.println("<td align='center'>");
					String realname2="";
					if(hospital.getDafenren3()!=null){
					User user1=udao.getUserByUsername(hospital.getDafenren3());
					realname2=user1.getRealname();}
					out.println(StringUtils.trimToEmpty(realname2));
					out.println("</td>");
					out.println("<td align='center'>");
					out.println("<a  href=yewuerrordelete.jsp?callid="
							+ hospital.getId() + " target=\"_self\">"+
							"删除 </a>");
					out.println("</td>");
					}
		...
		<form name="queryform1" action="yewuerrordianxingQuery.jsp" method="post">
	 ...
	 <td align="center" valign="middle" class="num_font"><div class="page1_box">
			<elile:navigateBar navigateform="navigateform"
								actionName="yewuerrordianxingQuery.jsp" formName="queryform1" />	
								  </div></td>
        </tr>
	 </table>
