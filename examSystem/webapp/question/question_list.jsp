...
<div class="container-fluid">
	<div class="panel panel-primary">
		...
		<div class="panel-body" style="padding-bottom:0px">
			<form class="form-inline" name="queryform" action="<%=request.getContextPath() %>/QuestionServlet" method="post">
				...
				<div class="row">
					...
					<div class="col-md-3 form-group">
						...
						<select class="form-control input-sm style2" id="questiontype" name="questiontype" style="width:120px;">
				...
				<div class="row" style="margin-top:8px;">
					...
					<div class="col-md-3 form-group">
		            	...
		            	<select class="form-control input-sm style2" id="gzdj" name="gzdj" style="width:120px;">
			                <option value="">全部</option>
			                <c:if test="${gzdj!=''}">
				...
				<div class="row" style="margin-top:8px;">
					<div class="col-md-3 col-md-offset-1 form-group">
						...
						<select class="form-control input-sm" id="state" name="state" style="width:200px" >
					...
					<div class="col-md-3 form-group">
						...
						<select class="form-control input-sm style3" id="difficulty" name="difficulty" style="width:120px;">
							<option value="0">全部</option>
			...
			<div class="row">
				<div class="col-md-1">
					<button class="btn btn-danger btn-xs" onclick="del()">
		...
		<table class="table table-striped table-bordered table-hover table-condensed text-center" >
         <tr class="info"> 
                ...
                <td width="8%"><span class="out">选项</span></td>
                ...
                <td width="8%"><span class="out">难易度</span></td>
                <td width="8%"><span class="out">重要程度</span></td>
                <td width="10%"><span class="out">录入时间</span></td>
                <td width="10%"><span class="out">状态</span></td>
          </tr>
        <c:forEach var="aBean" items="${list}" varStatus="status">
          <tr>
	            ...
	            <td>
	            	<p style="display:block;width:100px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" title="<c:out value="${aBean.xx}"/>"><c:out value="${aBean.xx}"/></p>
	            </td>
	            <td>
	            	<p style="display:block;width:60px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" title="<c:out value="${aBean.da}"/>"><c:out value="${aBean.da}"/></p>
	            </td>
