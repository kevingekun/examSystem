...
<%@page import="com.wondersgroup.falcon.question.dao.EBusinesstypeDAO,java.util.List,com.wondersgroup.falcon.model.citizeninfo.HisNode,com.wondersgroup.falcon.model.citizeninfo.HisAttr" %>
...
function addLine(obj,num){
	...
	<script language="javascript">	
		...
		function checkSubmit(){			
			...
			document.addform.state.value="1";			
			document.addform.submit();
		}	
		...
		function unpass(){			
			...
			document.addform.state.value="2";		
			document.addform.submit();
		}			
		...
		function bxTypeZhi(){
			<%-- var bx='<%=((EQuestionsVO)request.getAttribute("question")).getBxType()!=null?((EQuestionsVO)request.getAttribute("question")).getBxType():0%>'; --%>
			//document.getElementById("ST_BAOXIAN").value=bx;
		}
		function checkDj(v){
			var value = v.value;
...
<body class="nrbj" onload="bxTypeZhi();">
  ...
  <%-- <tr>
  	...
  	<td>
  		<div style="position: relative;width: 100%">
	  		<div style="width: 300px;height:200px;float:right;right:9;top:70;position:absolute; z-index:100;border: 2;border-color: red ">
	  			<img src="<%=request.getContextPath()%>/servlet/ImgServlet?stid=<c:out value="${question.stId}"/>" />
	  			<!-- 图片：<input id="img" name="img" type="file" /> -->
			</div>
...
<form name="addform" action="<%=request.getContextPath() %>/QuestionServlet" method="post">
 ...
 <input type=hidden name="myaction" value="check">
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" >
				<tr class="row_height">
			        ...
			        <td>
			        	...
			        	<select id="gzid" name="gzid" style="width:200px" ><!-- onchange="checkDj(this)"  -->
		        	...
		        	<td align="left">&nbsp;&nbsp;图片：
		        		<div style="position: relative;width: 100%">
					  		<div style="width: 300px;height:200px;float:left;left:42;top:-18;position:absolute; z-index:100;border: 2;border-color: red ">
					  			<c:if test="${question.stImg!=''}">
					  				<img class="imgPv" src="<%=request.getContextPath()%>/servlet/ImgServlet?stid=<c:out value="${question.stId}"/>" />
					  			</c:if>
					  			<c:if test="${question.stImg==''}">
					  				<img class="imgPv" src="<%=request.getContextPath()%>/images/default/default.png" />
					  			</c:if>
							</div>
		          	...
		          	<%-- <td >
			          	<div style="position: relative;width: 100%">
					  		<div style="width: 300px;height:200px;float:left;left:5;top:30;position:absolute; z-index:100;border: 2;border-color: red ">
					  			<img src="<%=request.getContextPath()%>/servlet/ImgServlet?stid=<c:out value="${question.stId}"/>" />
					  			<!-- 图片：<input id="img" name="img" type="file" /> -->
							</div>
				...
				<tr>
		            ...
		            <td width="18%">
		            	...
		            	<select id="gzdj" name="gzdj" style="width:200px" ><!-- onchange="checkTkid(this)" -->
		            		<option value="0">请选择</option>
                ...
                <tr>
			        ...
			        <td colspan=1><input type=text id="ST_CC" name="ST_CC" value="<c:out value="${question.stCc}"/>" style="width:200px" ></td>
			    </tr>
			    <tr>
			    ...
			    <tr height="60"></tr>
			    <%-- <tr>
			    	<td>图片：<input id="img" name="img" type="file" /></td>
		          	<td>
		          		<img src="<c:out value="${question.stImg}"/>" />
		          	</td>
			    </tr> --%>
			    <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
			       <!-- <tr>
                    <td height="40" align="center" valign="bottom">
					 ...
					 <input name="res" type="button"  class="submit_2" value="返 回" onclick="javascript:history.back();"/>
                    </td>
                  </tr> -->
                </table>		
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<%-- <td>
										<img src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=<c:out value="${arry[s.count-1]}"/>" />
									</td> --%>
									
									
									<%-- <td>
										<c:if test="${s.count==4}"><input name="add1" type="button" id="add2" value="增加" onClick="addLine(this,1)"></c:if>
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=A" />
								</td>
							</tr>
						</table>
					</td>	
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=B" />
								</td>
							</tr>
						</table>
					</td>	
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=C" />
								</td>
							</tr>
						</table>
					</td>	
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=D" />
								</td>
							</tr>
						</table>
					</td>	
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=E" />
								</td>
							</tr>
						</table>
					</td>	
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=F" />
								</td>
							</tr>
						</table>
					</td>	
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img class="img_xx" src="<%=request.getContextPath()%>/servlet/ImgServlet_xx?stid=<c:out value="${question.stId}"/>&xx=G"/>
								</td>
							</tr>
						</table>
					</td>	
				...
				<c:if test="${question.stImgA==''}">
					...
					<c:if test="${question.stImgG!=''}">
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="60"><input type=checkbox name="manyoptionkey" value="G" 
									<c:forTokens items="${question.stDa}" delims="||" var="da">
										<c:if test="${'G'==da}">checked</c:if>
										</c:forTokens>>G:</td>
									<td>
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table><tr>
							  <td><textarea id="verdictsay" name="verdictsay" style="width:580px;" rows="5"><c:if test="${question.stlx==14}"><c:out value="${question.stDasm}"/></c:if></textarea></td>
								<td>&nbsp;</td>
								<td></td></tr>
							</table></td>
					</tr>						
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table><tr>
							  <td><textarea name="recordkey" id="recordkey" style="width:580px;" rows="5"><c:if test="${question.stlx==15}"><c:out value="${question.stDa}"/></c:if></textarea></td>
								<td>&nbsp;</td>
								<td></td></tr>
							</table></td>
					</tr>						
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0"><tr>
							  <td><textarea name="fillkey" id="fillkey" style="width:580px;" rows="5"><c:if test="${question.stlx==6}"><c:out value="${question.stDa}"/></c:if></textarea></td>
								<td>请以一定符号间隔。</td>
								<td></td></tr>
							</table></td>
					</tr>						
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0"><tr>
							  <td><textarea name="askkey" id="askkey" style="width:580px;" rows="5"><c:if test="${question.stlx==4}"><c:out value="${question.stDa}"/></c:if></textarea></td>
								<td>&nbsp;</td>
								<td></td></tr>
							</table></td>
					</tr>						
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0"><tr>
							  <td><textarea name="casekey" id="casekey" style="width:580px;" rows="5"><c:if test="${question.stlx==18}"><c:out value="${question.stDa}"/></c:if></textarea></td>
								<td>&nbsp;</td>
								<td></td></tr>
							</table>
						</td>
			...
			<td width="80%" align="center">
				<table width=760 border=0 align="center" cellspacing ="1" cellspadding=1>
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0"><tr>
							  <td><textarea name="calculatekey" id="calculatekey" style="width:580px;" rows="5"><c:if test="${question.stlx==5}"><c:out value="${question.stDa}"/></c:if></textarea></td>
								<td>&nbsp;</td>
								<td></td></tr>
							</table>
						</td>
					...
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="60">
									<input type=checkbox name="uncertainoptionkey" value="<c:out value="${arry[s.count-1]}" />" 
									<c:forTokens items="${question.stDa}" delims="||" var="da">
									<c:if test="${arry[s.count-1]==da}">checked</c:if>
									</c:forTokens>>
									<c:out value="${arry[s.count-1]}"/>：
									</td>
									<td><textarea id="uncertainoption" name="uncertainoption" style="width:580px;" rows="2"><c:out value="${it}"/></textarea></td>
									<td><c:if test="${s.count==4}"><input name="add2" type="button" id="add2" value="增加" onClick="addLine(this,2)"></c:if>
									<c:if test="${s.count>4}"><input name="add2" type="button" id="add2" value="删除" onClick="addLine(this,2)">
									<script language="JavaScript">rowIndex++</script>
									</c:if>
															...
															<tr>
																<td>
																	<textarea name="discusskey" id="discusskey"
																		style="width: 750px; height: 50px;"><c:if test="${question.stlx==6}"><c:out value="${question.stDa}"/></c:if></textarea>
																</td>
																<td>
																	&nbsp;
																</td>
															...
															<tr>
																<td>
																	<textarea name="databasekey" id="databasekey"
																		style="width: 750px; height: 50px;"><c:if test="${question.stlx==12}"><c:out value="${question.stDa}"/></c:if></textarea>
																</td>
																<td>
																	&nbsp;
																</td>
...
<div id="div13" <c:if test="${question.stlx!=13}"> style="display:none"</c:if>>
															...
															<tr>
																<td>
																	<textarea name="telephonekey" id="telephonekey"
																		style="width: 750px; height: 50px;"><c:if test="${question.stlx==13}"><c:out value="${question.stDa}"/></c:if></textarea>
																</td>
																<td>
																	&nbsp;
																</td>
    		...
    		<table width="760" height="80" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:20px;">
                  <tr>
                    <td width="60" height="40" align="center" valign="middle">审核意见：</td>
                    <td colspan="3"><textarea id="ST_ADVICE" name="ST_ADVICE" style="width:580px;" rows="4"></textarea></td>
                  </tr>
                  <tr>
                    <td height="40" align="center" valign="bottom">&nbsp;</td>
                    <td colspan="3"><input name="add3" type=button class="submit_2" onClick="jvavscript:pass();"  value="审核通过"/>
                      &nbsp;
                    <input name="unpass2" type="button"  class="submit_2" onClick="jvavscript:upass();" value="审核不通过"/></td>
                  </tr>                  
          </table>
