...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:12px;">
       ...
       <input type=hidden name="actionType" value="query">
        <input type=hidden name="myaction" value="modifyload_st">
          ...
          <s:iterator value="faqNode_st" id="question" status="status">
   ...
   <s:form name="mypaperActionform" method="post" action="toView_Fst.action">
  		<input type="hidden" name="faqNodeId" value="<s:property value='faqNodeId'/>"/>
         <elile:navigateBar navigateform="navigateform" actionName="toView_Fst.action" formName="mypaperActionform"/>
	</s:form>
