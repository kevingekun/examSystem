...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:12px;">
		 ...
		 <br>
		 <s:form name="form111" method="post" action="toView_UpdatedQuestions.action">  		
	         <elile:navigateBar navigateform="navigateform" actionName="toView_UpdatedQuestions.action" formName="form111"/>        
		</s:form>
</td>
</tr>
</table>
