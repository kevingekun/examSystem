// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 2007-9-29 10:01:35
...
public class File {
	...
	public void saveAs(String s, int i) throws IOException,
		...
		System.out.println("file.java===>>>>>"+s);
		...
		try {
			...
			System.out.println("121212"+m_parent.m_binArray);
