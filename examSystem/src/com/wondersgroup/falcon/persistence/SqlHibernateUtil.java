...
public class SqlHibernateUtil {
	...
	private static Log log = LogFactory.getLog(SqlHibernateUtil.class);
...
//			configuration = new AnnotationConfiguration();
            configuration = new Configuration();//.addClass(com.wondersgroup.falcon.model.archives.Node.class);
			sessionFactory = configuration.configure("sqlhibernate.cfg.xml").buildSessionFactory();
