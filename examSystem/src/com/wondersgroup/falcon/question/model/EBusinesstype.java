...
/**
 * EBusinesstype entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class EBusinesstype implements java.io.Serializable {
...
//	private Set EQuestionses = new HashSet(0);
	...
	/** minimal constructor */
	public EBusinesstype(String name, long zt, long priority) {
		this.name = name;
		this.zt = zt;
	...
	/** full constructor */
	public EBusinesstype(String name, String descriptor, long zt,
			long priority
//			, Set EQuestionses
			) {
		this.name = name;
