...
/**
 * This is an object that contains data related to the rc_research table.
...
public abstract class BaseRcResearch  implements Comparable, Serializable {

	public static String REF = "RcResearch";
	 ...
	 */
	public BaseRcResearch (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.wondersgroup.falcon.model.rc.RcResearch)) return false;
		else {
			com.wondersgroup.falcon.model.rc.RcResearch rcResearch = (com.wondersgroup.falcon.model.rc.RcResearch) obj;
			if (null == this.getId() || null == rcResearch.getId()) return false;
			else return (this.getId().equals(rcResearch.getId()));
		}
	}
