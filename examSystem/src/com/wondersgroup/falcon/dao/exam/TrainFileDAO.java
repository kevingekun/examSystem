...
public class TrainFileDAO {
	
	
	public TrainFileDAO() throws InfrastructureException {
	...
	public void saveTrainFile(final TrainFile tf)
			throws Exception {
		        HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try {
	...
	public List findTrainFile(final int first,final int size)throws Exception{
		return (List) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					String hql = "from TrainFile t order by t.sendtime desc";
	...
	public List findTrainFileByCrit(final int first,final int size,final String username,final String realname,final String status,final String starttime,final String endtime)throws Exception{
		return (List) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					StringBuffer hql = new StringBuffer();
					hql.append("from TrainFile t where 1=1 ");
					if(!username.equals("")){
		...
		return (Integer) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					StringBuffer hql = new StringBuffer();
					hql.append("select count(*) from TrainFile t where 1=1 ");
					if(!username.equals("")){
						hql.append(" and t.sender.username='"+username+"'");
					}
					if(!realname.equals("")){
	...
	public int findAllTrainFile()throws Exception{
		return (Integer) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					String hql = "select count(*) from TrainFile t order by t.sendtime desc";
					Query query = session.createQuery(hql);
					list = query.list();
					if(list.size()>0){
	...
	public List findTrainFileBySender(final String username,final int first,final int size)throws Exception{
		return (List) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					String hql = "from TrainFile t where t.sender.username='"+username+"' order by t.sendtime desc";
					Query query = session.createQuery(hql);
					query.setFirstResult(first);
					query.setMaxResults(size);
					list = query.list();
	...
	public int findCountBySender(final String username,final int first,final int size)throws Exception{
		return (Integer) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					String hql = "select count(*) from TrainFile t where t.sender.username='"+username+"' order by t.sendtime desc";
					Query query = session.createQuery(hql);
					query.setFirstResult(first);
					query.setMaxResults(size);
					list = query.list();
	...
	public TrainFile findOneTrainFile(final String tfid)throws Exception{
		return (TrainFile) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					TrainFile tf = (TrainFile) session.load(TrainFile.class, tfid);
					return tf;
				}catch(Exception ex){
					ex.printStackTrace();
				}
	...
	public List findReplyBySid(final String tfid)throws Exception{
		return (List) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					String hql = "from TrainFileReply t where t.feedback.id='"+tfid+"' order by t.sendtime desc";
					Query query = session.createQuery(hql);
					list = query.list();
					return list;
				}catch(Exception ex){
	...
	public List findNoReadReply(final String username)throws Exception{
		return (List) HibernateUtil.doInSession(new HibernateSessionCallback() {
			public Object execute(Session session) throws Throwable {
				try{
					List list = new ArrayList();
					String hql = "from TrainFileReply t where t.isread=0 and t.feedback.sender.username='"+username+"' order by t.sendtime desc";
					Query query = session.createQuery(hql);
